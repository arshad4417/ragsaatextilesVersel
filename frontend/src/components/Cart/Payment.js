...
const Payment = () => {
	...
	const Roudy = async () => {
		...
		const { data } = await axios.post("http://localhost:4000/api/V1/paymentVerification", {
			paymentt
		})
	...
	return (
		...
		<>
			...
			<div className="container1" style={{display:"flex",marginTop:"10vmax",marginLeft:"10vmax",marginRight:"10vmax"}}>
				...
				<button type="button" style={{display:"flex",justifyContent:"center",alignItems:"center"}} onClick={checkoutHandlerONLINE} className="btn btn-outline-success">{`Pay - ₹${orderInfo && orderInfo.totalPrice}`}</button>
			</div>
			<div className="container2" style={{display:"flex",marginTop:"4vmax",marginLeft:"10vmax",marginRight:"10vmax"}}>
				<h2 style={{ color: "tomato",display:"flex"}}>&rarr;CASH ON DELIVERY -</h2>
				<button type="button" style={{display:"flex" ,justifyContent:"center",alignItems:"center"}} onClick={checkoutHandlerCOD} className="btn btn-outline-success">CASH ON DELIVERY</button>
			</div>
			<div className="container2" style={{display:"flex",marginTop:"10vmax",marginLeft:"10vmax",marginRight:"10vmax",justifyContent:"flex-end",alignItems:"center"}}>
				<p style={{ color: "tomato",display:"flex"}}>&rarr;Cancel Payment-</p>
				<button type="button" style={{display:"flex",justifyContent:"center",alignItems:"center"}} onClick={checkoutHandlerCancel} className="btn btn-outline-success">Cancel Payment</button>
			</div>
		</>
